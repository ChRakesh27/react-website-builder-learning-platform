...
export default function SectionDetailsPage() {
  ...
  return (
    <>
      <Link className="back-link" to="/sections">&larr; Back to all sections</Link>
      <section className="detail-hero">
        <div>
          <p className="eyebrow">{section.category} • {section.level}</p>
          <h1>{section.title}</h1>
          <p>{section.intro}</p>
        ...
        <div className="section-live-preview">
          ...
          <div className="preview-hero-row">
            <span>Main headline and subtext</span><span>Visual support panel</span>
          </div>
          <div className="preview-card-row"><span>Benefit 1</span><span>Benefit 2</span><span>Benefit 3</span></div>
        </div>
      </section>
