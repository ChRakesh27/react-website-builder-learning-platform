...
export default function Home() {
  const featured = sections.filter((section) =>
    ["hero", "features", "responsive-layout", "accessibility"].includes(section.slug),
  );
    ...
    <>
      ...
      <section className="section-block">
        ...
        <div className="path-grid">
          {learningPath.slice(0, 6).map((item, i) => (
            <article key={item.step} className="path-card scroll-reveal" style={{ transitionDelay: `${i * 100}ms` }}>
              <span>{item.step}</span>
              <h3>{item.title}</h3>
              <p>{item.text}</p>
            </article>
      ...
      <section className="section-block">
        ...
        <div className="grid four">
          {featured.map((section, i) => (
            <div key={section.slug} className="scroll-reveal" style={{ transitionDelay: `${i * 100}ms` }}>
