    ...
    <>
      ...
      <section className="section-block two-column">
        <article className="do-card">
          <h2>Do</h2>
          <ul>
            <li>Use clear meaningful names.</li>
            <li>Keep component file and component name same.</li>
            <li>Use kebab-case for routes and images.</li>
        ...
        <article className="dont-card">
          ...
          <ul>
            ...
            <li>Do not use random names like file1.jsx.</li>
            <li>Do not mix naming styles inside same folder.</li>
            <li>Do not create too many index.jsx files for beginners.</li>
          </ul>
        </article>
      </section>
