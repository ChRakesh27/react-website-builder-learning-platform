      ...
      <div className="mx-auto grid w-full max-w-5xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur">
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-slate-300">
            Use your Supabase project credentials to sign in or create a new
            account.
          </p>
        ...
        <Card className="border-slate-200/80 bg-white text-slate-950 shadow-2xl shadow-slate-950/10">
          <CardHeader>
          ...
          <CardContent>
            <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              <p className="text-sm leading-6 text-slate-500">
                Email/password auth must be enabled in your Supabase project.
              </p>
              <Link
